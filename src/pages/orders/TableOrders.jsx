            ...
            <nav aria-label="Page navigation example" className="d-flex justify-content-center">
                <ul className="pagination dir_ltr">
                    <li className="page-item">
                        <a className="page-link" href="tst" aria-label="Previous">
                        <span aria-hidden="true">&raquo;</span>
                        </a>
                    </li>
                    <li className="page-item"><a className="page-link" href="tst">1</a></li>
                    <li className="page-item"><a className="page-link" href="tes">2</a></li>
                    <li className="page-item"><a className="page-link" href="test">3</a></li>
                    <li className="page-item">
                        <a className="page-link" href="tst" aria-label="Next">
